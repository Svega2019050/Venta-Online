...
api.post("/createProduct/:idC", [mdAuth.ensureAuth, mdAuth.ensureAuthAdmin],productController.setProduct);
api.get("/getProduct/:idP", [mdAuth.ensureAuth, mdAuth.ensureAuthAdmin],productController.getProduct);
